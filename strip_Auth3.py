...
def Stripe3(ccx):
    ...
    link = "https://nutbaby.co.nz/my-account/add-payment-method/"
    ...
    if pk_live2:
        ...
        pk_live = "pk_live_51ObuzAKnPfgDROKjQBKtNByckOoyVEvtGhUwF0Zm4QagpzDDC5wTEeWaYiefEQP6jv1wV8D7ctGKedFe9HxNZHo900uptSrlmz"
        if not pk_live:
