...
def Stripe4(ccx):
    ...
    link = "https://cucciobeauty.co.uk/my-account/add-payment-method/"
    ...
    if pk_live2:
        ...
        pk_live = "pk_live_51JEunOFB9sxchd5wgpRZnP6VAcniiIT3GWrIFzvKSFRDhg8i8Y02LWk7DpmumzYLOfX5sv7yQJllm3Ir7pqSCBNq00eOAzeWWn"
        if not pk_live:
