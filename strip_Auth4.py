...
def Stripe4(ccx):
    """
    فحص بطاقة على nutbaby.co.nz (Stripe - Auth - Register with username + email + password)
    ccx: رقم|شهر|سنة|cvv
    """
    try:
        ccx = ccx.strip()
        ...
        # ===== 2. تسجيل حساب جديد (يوزر + إيميل + باسورد) =====
        #print("\n[2/6] تسجيل حساب جديد...")
