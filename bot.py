...
def check_mass_cards(user_id, cards, gateway_func, gateway_name, message_id, stop_key):
    ...
    approved = 0
    declined = 0
    consecutive_errors = 0  # عداد الأخطاء المتتالية
    ...
    def update_display():
        ...
        kb.add(
            ...
            InlineKeyboardButton(f"⚠️ Errors: {consecutive_errors}/{MAX_CONSECUTIVE_ERRORS}", callback_data="none"),
        ...
        try:
            ...
            if "Charged" in result or "✅" in result or "Approved" in result:
                ...
                if consecutive_errors >= MAX_CONSECUTIVE_ERRORS:
                    ...
                    error_msg += f"❌ {consecutive_errors} consecutive errors\n"
