...
def Stripe2(ccx):
    ...
    link = "https://seliniaction.com.gr/my-account/add-payment-method/"
    ...
    if pk_live2:
        ...
        pk_live = "pk_live_51H7GNFEU2jy2CGiXpzoYr9N8g8LkluP2kzej2VIaYSGmooe9U21PZzfGutPx9LFBYbM131ApF1420takGO1syPt800UrU3Nh5Y"
        if not pk_live:
