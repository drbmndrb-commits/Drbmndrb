...
def Stripe1(ccx):
    ...
    headers = {
        ...
        'referer': 'https://simplesympathy.com/my-account/',
    ...
    headers = {
        ...
        'origin': 'https://simplesympathy.com',
        'referer': 'https://simplesympathy.com/my-account/',
        'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
        'sec-ch-ua-mobile': '?1',
        'sec-ch-ua-platform': '"Android"',
    ...
    headers = {
        ...
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9',
        'accept-language': 'ar-EG,ar;q=0.9,en-US;q=0.8,en;q=0.7',
        'referer': 'https://simplesympathy.com/my-account/payment-methods/',
        'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
        'sec-ch-ua-mobile': '?1',
        'sec-ch-ua-platform': '"Android"',
        'sec-fetch-dest': 'document',
    ...
    headers = {
        ...
        'origin': 'https://simplesympathy.com',
        'referer': 'https://simplesympathy.com/my-account/add-payment-method/',
        'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
        'sec-ch-ua-mobile': '?1',
        'sec-ch-ua-platform': '"Android"',
        'sec-fetch-dest': 'empty',
